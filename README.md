...
**Période :** 31 août - 6 septembre 2026

[Voir la newsletter](./dist/archive/AI_Weekly_2026-08-31_to_2026-09-06.html)
...
- **1 septembre 2026** : édition pour la période du 31 août au 6 septembre 2026, avec 27 actualités couvrant 3 sources actives. Semaine marquée par le lancement de GenAI.mil au Pentagone pour 3 millions d'utilisateurs (ChatGPT Mil, Grok, Gemini), la désignation de ChatGPT sous le niveau le plus strict du DSA européen (159M utilisateurs), la révélation de trois civilisations d'agents IA chez OpenAI (1 200 agents, 70K+ messages), Sony Music et Warner poursuivant Anthropic pour violation massive de copyright, DeepSeek-V4-Flash-Vision-Exp (305B params, MIT), les pubs ChatGPT à 1 Md$ annualisés, Anthropic verrouillant ses sandboxes après des évasions de Claude, la fermeture de Mechanical Turk après 21 ans, et les malwares voleurs de sessions Claude contournant le 2FA.
